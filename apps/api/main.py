...
from apps.api.routers import admin, alerts, analysis, assistant, auth, backtests, charts, health, instruments, portfolios, reports, scanner, signals, watchlists
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://127.0.0.1:3000", "http://web:3000"] if settings.api_env == "development" else [],
